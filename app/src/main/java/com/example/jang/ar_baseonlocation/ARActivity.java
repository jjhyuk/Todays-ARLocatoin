...
public class ARActivity extends AppCompatActivity implements SensorEventListener {
    private final int SOURCE_PLACE_PICKER_REQUEST = 2;
        ...
        tvCurrentLocation.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                try {
                    ...
                    Log.d(TAG, "1");
                    startActivityForResult(builder.build(ARActivity.this), SOURCE_PLACE_PICKER_REQUEST);
                    Log.d(TAG, "2");
    ...
    private void updateLatestLocation() {
        if (arOverlayView !=null && location != null) {
            ...
            Log.d(TAG, "updateLatesdtLocation: "+location.getLatitude()+","+location.getLongitude());
        ...
        switch(requestCode){
            case SOURCE_PLACE_PICKER_REQUEST:
                if(resultCode == RESULT_OK) {
                    ...
                    Toast.makeText(getApplicationContext(),"srcRes : "+srcRes,Toast.LENGTH_LONG).show();

                    Toast.makeText(getApplicationContext(),"srcLatLong : "+place.getLatLng(),Toast.LENGTH_LONG).show();
